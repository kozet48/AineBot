...
/**
 * REFACTORING CODE by Armin Fajar (https://github.com/ibnusyawall)
...
const config = {
    BotName: 'Teman Kaze',
    instagram: 'https://www.instagram.com/official_kozet',
    whatsapp: 'wa.me/628994622890',
...
// client.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log(`${time}: Bot by ig:@official_kozet`)

client.on('message-status-update', json => {
   const participant = json.participant ? ' (' + json.participant + ')' : ''
   console.log(`[ ${time} ] => bot by ig:@official_kozet`)
})
